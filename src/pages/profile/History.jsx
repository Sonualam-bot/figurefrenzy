                ...
                {paymentId ?
                    (<div className="order_main_details" >
                        <div className="order_payment_details" >
                            ...
                            <p>Order Date :  <span> {today} </span>  </p>
                            <p>Total Amount : <span>₹{Math.round(finalPrice)}</span>  </p>
                            <div>Order address :
                                {/* <p> */}
                                <span> {addressForOrder?.city}</span>
                                <span> {addressForOrder?.state} </span>
                                <p>Mobile: <span>  {addressForOrder?.mobile} </span>  </p>
                                <p>Pin:-  <span>  {addressForOrder?.pincode} </span> </p>
                                ...
                                return (
                                    <div className="order_details_div" >
                                        ...
                                        <div className="order_summary" >
                                            <p> {el.name}  </p>
                                            <p> ₹{Math.round(el.price)}  <span> ₹{Math.round(el.originalPrice)}</span>   </p>
                                            <p> {el.discount} %OFF </p>
                                            <p> Quantity: {el.qty} </p>
                                        </div>
